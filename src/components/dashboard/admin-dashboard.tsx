...
import { UserCheck, Search, ListChecks, Repeat, MessageSquare, History, ShieldCheck, BarChart2, Gift, Library } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <main className="container mx-auto max-w-7xl p-4 py-8 sm:p-6 lg:p-8 space-y-8">
        ...
        <Tabs defaultValue={activeTab || "verifications"} className="w-full">
            ...
            <TabsContent value="verifications" className="space-y-8 mt-6">
                 <UserTable 
            ...
            <TabsContent value="requests" className="space-y-8 mt-6">
                <RequestTable 
