...
import { 
    ...
    Search, RefreshCw, Filter, Download, ArrowUpRight, ArrowDownRight,
    PieChart, BarChart3, LineChart, CheckCircle2, AlertCircle, Printer
} from 'lucide-react';
                    ...
                    <TableBody>
                        {loading ? Array(5).fill(0).map((_, i) => (
                            ...
                            <TableRow key={tx.id}>
                                ...
                                <TableCell><Badge className="bg-green-100 text-green-700 hover:bg-green-100">{tx.status}</Badge></TableCell>
    ...
    const renderReports = () => (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                    <CardHeader><CardTitle className="text-base">Commission Trends</CardTitle></CardHeader>
                ...
                <Card>
                    <CardHeader><CardTitle className="text-base">Trainer Share Distribution</CardTitle></CardHeader>
                    <CardContent className="h-[200px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={data?.trainerEarnings || []} layout="vertical">
                                <XAxis type="number" hide />
                                <YAxis dataKey="trainerName" type="category" width={80} style={{ fontSize: '10px' }} />
                                <Tooltip formatter={(val) => `₹${Number(val).toLocaleString('en-IN')}`} />
                                <Bar dataKey="earnings" fill="#22c55e" radius={[0, 4, 4, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </CardContent>
                </Card>
        ...
        <div className="container mx-auto max-w-7xl p-4 py-8 sm:p-6 lg:p-8 space-y-8">
            <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Comprehensive financial oversight and payout control.</p>
                </div>
                <div className="flex gap-2">
