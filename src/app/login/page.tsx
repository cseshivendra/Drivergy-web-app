...
import { Car, Smartphone, ShieldAlert } from 'lucide-react';
...
export default function LoginPage() {
  ...
  // Placeholder for Google icon, replace with actual SVG or component if available
  const GoogleIcon = () => (
       ...
       <Card className="w-full max-w-md shadow-2xl z-10 rounded-xl border-border/50">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md text-yellow-700 text-sm flex items-start">
            ...
            <span>OTP login is currently under development. Please use Google Sign-In.</span>
          </div>
        </CardContent>
