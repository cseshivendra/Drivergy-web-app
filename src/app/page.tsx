      ...
      {/* Subscription Plans Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start justify-center">
                {/* Basic Plan */}
                <div className="perspective-1000 h-[40rem] w-full max-w-sm mx-auto">
                    <div className={cn("relative w-full h-full transform-style-3d transition-transform duration-700", { 'rotate-y-180': flippedCardId === 'basic-plan' })}>
                        <Card className="absolute w-full h-full backface-hidden shadow-lg hover:shadow-xl flex flex-col transition-transform duration-300 hover:-translate-y-2 overflow-hidden">
                        ...
                        <Card className="absolute w-full h-full backface-hidden rotate-y-180 shadow-lg flex flex-col p-6 bg-primary text-primary-foreground overflow-hidden">
                ...
                {/* Gold Plan */}
                <div className="perspective-1000 h-[40rem] w-full max-w-sm mx-auto md:col-span-2 lg:col-span-1 flex justify-center">
