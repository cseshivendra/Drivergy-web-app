                    ...
                    <div className={cn("relative w-full h-full transform-style-3d transition-transform duration-700", { 'rotate-y-180': flippedCardId === 'basic-plan' })}>
                        <Card className="absolute w-full h-full backface-hidden shadow-lg hover:shadow-xl flex flex-col transition-transform duration-300 hover:-translate-y-2">
                            ...
                            <CardContent className="flex-grow space-y-4">
                                <div className="flex items-center justify-center gap-x-2 mb-2"><p className="text-4xl font-bold">₹2,499</p><p className="text-xl font-medium text-muted-foreground line-through">₹3,999</p></div>
                            ...
                            <CardFooter className="mt-auto pt-6 grid grid-cols-2 gap-2"><Button className="w-full" variant="outline" onClick={() => setFlippedCardId('basic-plan')}>Details</Button><Button className="w-full" asChild><Link href="/payment?plan=Basic&price=2499">Buy Course</Link></Button></CardFooter>
                        </Card>
                        <Card className="absolute w-full h-full backface-hidden rotate-y-180 shadow-lg flex flex-col p-6 bg-primary text-primary-foreground">
                            ...
                            <CardFooter className="grid grid-cols-2 gap-2"><Button variant="secondary" onClick={() => setFlippedCardId(null)}>Back</Button><Button variant="secondary" asChild><Link href="/payment?plan=Basic&price=2499">Buy Course</Link></Button></CardFooter>
                        </Card>
                    </div>
                </div>
                    ...
                    <div className="perspective-1000 h-[30rem] w-full transform md:scale-105">
                        <div className={cn("relative w-full h-full transform-style-3d transition-transform duration-700", { 'rotate-y-180': flippedCardId === 'premium-plan' })}>
                            ...
                            <Card className="absolute w-full h-full backface-hidden shadow-xl hover:shadow-2xl border-2 border-primary overflow-hidden flex flex-col bg-card transition-transform duration-300 hover:-translate-y-2">
                                ...
                                <CardContent className="flex-grow space-y-4">
                                    <div className="flex items-center justify-center gap-x-2 mb-2"><p className="text-4xl font-bold">₹2,499</p><p className="text-xl font-medium text-muted-foreground line-through">₹9,999</p></div>
                                ...
                                <CardFooter className="mt-auto pt-6 grid grid-cols-2 gap-2"><Button className="w-full" variant="outline" onClick={() => setFlippedCardId('premium-plan')}>Details</Button><Button className="w-full bg-primary hover:bg-primary/90" asChild><Link href="/payment?plan=Premium&price=2499">Buy Course</Link></Button></CardFooter>
                            </Card>
                            {/* Back */}
                            <Card className="absolute w-full h-full backface-hidden rotate-y-180 shadow-lg flex flex-col p-6 bg-primary text-primary-foreground">
                                ...
                                <CardFooter className="grid grid-cols-2 gap-2"><Button variant="secondary" onClick={() => setFlippedCardId(null)}>Back</Button><Button variant="secondary" asChild><Link href="/payment?plan=Premium&price=2499">Buy Course</Link></Button></CardFooter>
                            </Card>
                        </div>
                    </div>
                </div>
                ...
                <div className="perspective-1000 h-[30rem]">
                    <div className={cn("relative w-full h-full transform-style-3d transition-transform duration-700", { 'rotate-y-180': flippedCardId === 'gold-plan' })}>
                        <Card className="absolute w-full h-full backface-hidden shadow-lg hover:shadow-xl flex flex-col transition-transform duration-300 hover:-translate-y-2">
                            ...
                            <CardContent className="flex-grow space-y-4">
                                <div className="flex items-center justify-center gap-x-2 mb-2"><p className="text-4xl font-bold">₹2,499</p><p className="text-xl font-medium text-muted-foreground line-through">₹7,499</p></div>
                            ...
                            <CardFooter className="mt-auto pt-6 grid grid-cols-2 gap-2"><Button className="w-full" variant="outline" onClick={() => setFlippedCardId('gold-plan')}>Details</Button><Button className="w-full" asChild><Link href="/payment?plan=Gold&price=2499">Buy Course</Link></Button></CardFooter>
                        </Card>
                         <Card className="absolute w-full h-full backface-hidden rotate-y-180 shadow-lg flex flex-col p-6 bg-primary text-primary-foreground">
                            ...
                            <CardFooter className="grid grid-cols-2 gap-2"><Button variant="secondary" onClick={() => setFlippedCardId(null)}>Back</Button><Button variant="secondary" asChild><Link href="/payment?plan=Gold&price=2499">Buy Course</Link></Button></CardFooter>
                        </Card>
                    </div>
                </div>
            </div>
