...
import { CreditCard, Calendar, Lock, Car } from 'lucide-react';
...
export default function PaymentPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `Your subscription for the ${plan} plan has been activated.`,
    });
            ...
            <Card className="w-full max-w-md shadow-xl">
                ...
                <CardContent>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <Label htmlFor="cardHolderName" className="flex items-center mb-1">Cardholder Name</Label>
